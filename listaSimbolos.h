...
/* Comprueba si un "nombre" está contenido en la "lista" */
int perteneceTablaS (Lista lista, char *nombre);
/* Añade "nombre" a la lista */
void añadeEntrada (Lista lista, char *nombre, Tipo tipo);
/* Comprueba si "nombre" es constante */
int esConstante (Lista lista, char *nombre);
/* Imprime la tabla de símbolos en formato de código de MIPS */
